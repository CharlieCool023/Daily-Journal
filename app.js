...
app.get("/", function(req, res){
  res.render("home", {homeStartingContent1: homeStartingContent, posts: posts})
...
app.get("/posts/:topic", function(req, res){
  ...
  const input1 = _.lowerCase(req.params.topic);
  
  posts.forEach(function(post){
    const storedTitle = _.lowerCase(post.title);
    
    if (input1 === storedTitle){
...
app.post("/compose", function(request, response){
    ...
    const post = {
      title: request.body.composeText,
